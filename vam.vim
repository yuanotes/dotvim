...
call vam#ActivateAddons(['github:uggedal/go-vim', 'vim-octopress', 'The_NERD_Commenter', 'Syntastic','The_NERD_tree','sudo','Command-T', 'fugitive', 'VimOrganizer', 'Zenburn', 'Powerline', 'Tagbar', 'vimproc', 'neocomplcache', 'neosnippet', 'L9', 'FuzzyFinder', 'YankRing', 'ZenCoding', 'quickrun%3146'])
