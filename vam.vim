...
call vam#ActivateAddons(['github:uggedal/go-vim', 'vim-octopress', 'ctrlp', 'The_NERD_Commenter', 'Syntastic','The_NERD_tree','sudo','fugitive', 'vim-orgmode', 'Zenburn', 'github:Lokaltog/powerline', 'Tagbar', 'vimproc', 'neocomplcache', 'neosnippet','YankRing', 'ZenCoding', 'quickrun%3146'])
